...
- **Enhanced encoding support for special characters (v0.2.0)**
  - Improved encoding detection for ASC and ASY parsers
  - Added support for UTF-8, UTF-16LE, ASCII, and latin1 encodings
  - Fixed issue with µ (micro) symbol in component values
  - Reduced debug noise by showing encoding errors only when all encodings fail
  - Reordered encoding priority: UTF-8, UTF-16LE, ASCII, latin1
- **Automated PyPI publishing setup (v0.2.0)**
  - Implemented GitHub Actions workflows for automated PyPI publishing
  - Configured PyPI trusted publishing using OIDC for secure authentication
  - Added build and publish pipeline triggered by releases and tags
  - Created comprehensive publishing documentation
  - Removed CI testing due to Linux/LTspice compatibility limitations
...
### Python Release Best Practices Implementation Status

✅ **COMPLETED (v0.2.0)**
1. **Release Automation**
   - ✅ Git tags for version releases (`v0.2.0` tag created)
   - ✅ GitHub Actions workflows for automated PyPI publishing
   - ✅ PyPI trusted publishing configured with OIDC authentication
   - ✅ Build and publish pipeline triggered by releases and tags

2. **Project Governance** 
   - ✅ SECURITY.md for vulnerability reporting procedures
   - ✅ CONTRIBUTING.md with development guidelines
   - ✅ Publishing documentation with setup instructions
